    ...
    return (
      <>
        <div style={{ display: "inline" }}>
          ...
          <div>Liquidation Ratio: {this.props.store.liquidationRatio.get()}</div>
          <div>ETH/PETH Ratio: {this.props.store.wethToPeth.get().toFixed(4)}</div>
        </div>
        <div style={{ display: "inline" }}>
          <div>DAI Balance: {this.props.store.daiBalance.get().toString(4)}</div>
          <div>MKR Balance: {this.props.store.mkrBalance.get().toString(4)}</div>
          <div>ETH Balance: {this.props.store.ethBalance.get().toString(4)}</div>
        </div>
        <br />
